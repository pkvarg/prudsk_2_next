    ...
    <>
      <CookieConsent
        ...
        style={{
          ...
          alignItems: 'center',
          gap: '16px',
          justifyContent: 'space-between', // <-- 1. ADDED THIS
        }}
        containerClasses="cookie-consent-container"
        contentStyle={{
          flex: '1 1 auto',
          ...
          wordWrap: 'break-word',
          lineHeight: '1.6',
          minWidth: '200px', // Added for safety to prevent over-squishing text
        }}
        // --- 2. THIS IS THE MAIN FIX ---
        buttonWrapperClasses="flex flex-row gap-3 w-full justify-center lg:w-auto lg:justify-start lg:shrink-0"
        // --- END OF FIX ---
        buttonStyle={{
          background: 'linear-gradient(135deg, #22c55e 0%, #16a34a 100%)',
          color: '#fff',
