      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <FormContainer>
          <div className="max-w-md mx-auto">
            <h1 className="text-2xl font-bold text-[#071e46] mb-6">Spôsob platby</h1>
                      ...
                      <>
                        ...
                        <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                          <input
                            type="radio"
                            name="paymentMethod"
                            value="Platba bankovým prevodom vopred"
                            checked={method === 'Platba bankovým prevodom vopred'}
                            onChange={(e) => setMethod(e.target.value)}
                            className="w-4 h-4 text-[#071e46] border-gray-300 focus:ring-[#071e46] focus:ring-2"
                          />
                          <span className="ml-3 text-[#071e46]">
                        ...
                        <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                          <input
                            ...
                            className="w-4 h-4 text-[#071e46] border-gray-300 focus:ring-[#071e46] focus:ring-2"
                          />
                          <span className="ml-3 text-[#071e46]">Hotovosť pri prevzatí</span>
                        </label>
                      </>
                    ) : (
                      <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
